...
public class UpdateBook extends HttpServlet {
   ...
   final static String URL = "jdbc:mysql://121.36.209.216/linux_final";
   final static String USER = "root";
   final static String PASS = "GJMYyyds233*";
   final static String SQL_INSERT_BOOK = "UPDATE t_Book SET name = ?,author =? WHERE id=?;";
